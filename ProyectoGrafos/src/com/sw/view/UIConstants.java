...
public interface UIConstants
{
    ...
    public static final Border TABLE_HIGHLIGHT_BORDER = (Border) UIManager.get("List.focusCellHighlightBorder");

    public static final Icon EDITAR_ICON = new ImageIcon(UIConstants.class.getClass().getResource("/com/sw/img/editar.png"));
    public static final Icon DELETE_ICON = new ImageIcon(UIConstants.class.getClass().getResource("/com/sw/img/delete.png"));
